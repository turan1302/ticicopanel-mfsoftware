                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" @submit.prevent="yeniYetkiEkle()" enctype="multipart/form-data">
...
<script>
export default {
    name: "AdminYetkilerCreateComponent",
    props: ["geriye_don"],
    data() {
        return {
            yt_baslik: '',
    ...
    methods: {
        yeniYetkiEkle() {
            ...
            if (this.errors.length == 0) {
                ...
                var url = "http://127.0.0.1:8000/api/back/yetkiler/store";
