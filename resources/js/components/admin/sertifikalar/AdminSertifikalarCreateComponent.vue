                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" @submit.prevent="yeniSertifikaEkle()" enctype="multipart/form-data">
...
<script>
export default {
    name: "AdminSertifikalarCreateComponent",
    props: ["geriye_don"],
    data() {
        return {
            sr_baslik: '',
    ...
    methods: {
        yeniSertifikaEkle() {
            ...
            if (this.errors.length == 0) {
                ...
                var url = "http://127.0.0.1:8000/api/back/sertifikalar/store";
